...
- [1. 파이버 아키텍처에 대한 간략한 소개](#heading-1)
  - [1.1 `FiberRootNode`](#heading-11-fiberrootnode)
  - [1.2 `FiberNode`](#heading-12-fibernode)
- [2. 최초 마운트: Trigger 단계](#heading-2-trigger)
- [3. 최초 마운트: Render 단계](#heading-3-render)
  - [3.1 `performConcurrentWorkRoot()`](#heading-31-performconcurrentworkroot)
  - [3.2 `renderRootSync()`](#heading-32-renderrootsync)
  - [3.3 `performUnitOfWork()`](#heading-33-performunitofwork)
  - [3.4 `prepareFreshStack()`](#heading-34-preparefreshstack)
  - [3.5 `updateHostRoot()`](#heading-35-updatehostroot)
  - [3.6 `reconcileChildren()`](#heading-36-reconcilechildren)
  - [3.7 `reconcileChildFibers()` vs `mountChildFibers()`](#heading-37-reconcilechildfibers-vs-mountchildfibers)
  - [3.8 `reconcileSingleElement()`](#heading-38-reconcilesingleelement)
  - [3.9 `placeSingleChild()`](#heading-39-placesinglechild)
  - [3.10 `mountIndeterminateComponent()`](#heading-310-mountindeterminatecomponent)
- [3.11 `updateHostComponent()`](#heading-311-updatehostcomponent)
  - [3.12 `updateHostTest()`](#heading-312-updatehosttest)
  - [3.13 DOM 노드는 `completeWork()`내에서, 즉 화면 외부에서 생성됩니다.](#heading-313-dom-completework)
- [4. 최초 마운트: Commit 단계](#heading-4-commit)
  - [4.1 `commitMutationEffects()`](#heading-41-commitmutationeffects)
  - [4.2 `commitReconciliationEffects()`](#heading-42-commitreconciliationeffects)
  - [4.3 `commitPlacement()`](#heading-43-commitplacement)
- [5. 요약](#heading-5)
---
